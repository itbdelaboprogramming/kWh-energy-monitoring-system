...
class node:
    ...
    def save_read(self,response,save,num):
        ...
        if save == 2:
            ...
            self.Temperature_max        = (response.registers[7]-55)  # deg Celcius
            self.Temperature_min        = (response.registers[8]-55)  # deg Celcius
            self.Temperature_avg        = (response.registers[9]-55)  # deg Celcius
        ...
        if save == 3:
            ...
            self.Module_Temperature[num][0]     = (response.registers[13]-55)      # deg Celcius
            self.Module_Temperature[num][1]     = (response.registers[14]-55)      # deg Celcius
        if save == 4:
            for m in range(len(self.Module_Voltage)):
                self.Module_Temperature[m][2]   = (response.registers[m]-55)       # deg Celcius
